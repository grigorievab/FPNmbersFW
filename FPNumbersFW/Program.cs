...
namespace FPNumbers
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            f = 0.109344482421875f; // 3583/32768
            d = 0.109344482421875;
            ...
            _controlfp(_PC_24, _MCW_PC);
            Console.WriteLine("Epsilon, 24 bits");
            f = 1;
            while (1 + f / 2 > 1)
                f /= 2;
            Console.WriteLine($"Float epsilon, simple: {f}");
            f = 1;
            while (true)
            {
                f2 = f / 2;
            ...
            Console.WriteLine($"Float epsilon, by steps: {f}");
            d = 1;
            while (1 + d / 2 > 1)
                d /= 2;
            Console.WriteLine($"Double epsilon, simple: {d}");
            d = 1;
            while (true)
            {
                d2 = d / 2;
            ...
            Console.WriteLine($"Double epsilon, by steps: {d}");
            Console.WriteLine();

            _controlfp(_PC_64, _MCW_PC);
            Console.WriteLine("Epsilon, 64 bits");
            f = 1;
            while (1 + f / 2 > 1)
                f /= 2;
            Console.WriteLine($"Float epsilon, simple: {f}");
